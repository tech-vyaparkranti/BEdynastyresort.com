...
@section('content')
    ...
    <x-dashboard-container container_header="Manage Awards">
        <x-card>
            <x-card-header>Add Awards</x-card-header>
            <x-card-body>
                <x-form>
        ...
        <x-card>
            <x-card-header>Awards Data</x-card-header>
            <x-card-body>
        ...
        $(function() {
            ...
            table = $('.data-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: '{{ \App\Models\Awards::POSITION }}',
                        name: '{{ \App\Models\Awards::POSITION }}',
                        title: "Position"
                    },
                ]
            });
