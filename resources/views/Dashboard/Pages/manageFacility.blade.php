...
@section('content')
    ...
    <x-content-div heading="Manage Facility">
        <x-card-element header="Add Facility Data ">
            <x-form-element method="POST" enctype="multipart/form-data" id="submitForm" action="javascript:">
                <x-input type="hidden" name="id" id="id" value=""></x-input>
                <x-input type="hidden" name="action" id="action" value="insert"></x-input>

                <x-input-with-label-element id="image" label="Upload Facility Icon" name="icon" type="file"
                    accept="image" required></x-input-with-label-element>
                <x-input-with-label-element id="title" label="Facility title" name="title"
                    required></x-input-with-label-element>
                <x-text-area-with-label id="content" label="Facility Short Description" name="description"
        ...
        <x-card-element header="Facility Data">
            <x-data-table>
