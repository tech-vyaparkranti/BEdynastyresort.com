...
@section('title', 'Business Conferences')
@section('content')

    <x-content-div heading="Manage Business Conferences ">
        <x-card-element header="Add Business Conferences Data ">
            <x-form-element method="POST" enctype="multipart/form-data" id="submitForm" action="javascript:">
                ...
                <x-input-with-label-element id="title" label="Conferences title" name="title"
                    required></x-input-with-label-element>
                <x-text-area-with-label id="short_desc" label="Conferences Short Description" name="short_desc"
                    required></x-text-area-with-label>
                <x-text-area-with-label id="content" label="Conferences Description" name="description"
                    required></x-text-area-with-label>
        ...
        <x-card-element header="Business Conferences Data">
            <x-data-table>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".edit", function() {
            ...
            if (row['id']) {
                ...
                $("#title").val(row['title']);
                $("#short_desc").val(row['short_desc']);
                $('#short_desc').summernote('destroy');
                $('#short_desc').summernote({
                    focus: true
                });
