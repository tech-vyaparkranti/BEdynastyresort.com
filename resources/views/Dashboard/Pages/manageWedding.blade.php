...
@section('content')
    ...
    <x-content-div heading="Manage Wedding ">
        <x-card-element header="Add Wedding Data ">
            <x-form-element method="POST" enctype="multipart/form-data" id="submitForm" action="javascript:">
                ...
                <x-input-with-label-element id="title" label="Wedding title" name="title"
                    required></x-input-with-label-element>
                <x-text-area-with-label id="short_desc" label="Wedding Short Description" name="short_desc"
                    required></x-text-area-with-label>
                <x-text-area-with-label id="content" label="Wedding Description" name="description"
                    required></x-text-area-with-label>
        ...
        <x-card-element header="Wedding Data">
            <x-data-table>
