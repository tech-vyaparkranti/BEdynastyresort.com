...
@section('content')
    ...
    <x-content-div heading="Manage Activity">
        <x-card-element header="Add Activity Data ">
            <x-form-element method="POST" enctype="multipart/form-data" id="submitForm" action="javascript:">
                <x-input type="hidden" name="id" id="id" value=""></x-input>
                <x-input type="hidden" name="action" id="action" value="insert"></x-input>

                <x-input-with-label-element id="image" label="Upload Activity Image" name="image" type="file"
                    accept="image/*" required></x-input-with-label-element>
                <x-input-with-label-element id="title" label="Activity title" name="title"
                ...
                <x-text-area-with-label id="content" label="Activity Description" name="description"
        ...
        <x-card-element header="Activity Data">
            <x-data-table>
