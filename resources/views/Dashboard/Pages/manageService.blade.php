...
@section('content')
    ...
    <x-content-div heading="Manage Service">
        <x-card-element header="Add Service Data ">
            <x-form-element method="POST" enctype="multipart/form-data" id="submitForm" action="javascript:">
                <x-input type="hidden" name="id" id="id" value=""></x-input>
                <x-input type="hidden" name="action" id="action" value="insert"></x-input>

                <x-input-with-label-element id="image" label="Upload Service Image" name="image" type="file"
                    accept="image/*" required></x-input-with-label-element>
                <x-input-with-label-element id="title" label="Service title" name="title"
                ...
                <x-text-area-with-label id="content" label="Service Description" name="description"
        ...
        <x-card-element header="Service Data">
            <x-data-table>
