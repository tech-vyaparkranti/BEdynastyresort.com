...
@section('title', 'Satsang')
@section('content')

    <x-content-div heading="Manage Satsang ">
        <x-card-element header="Add Satsang Data ">
            <x-form-element method="POST" enctype="multipart/form-data" id="submitForm" action="javascript:">
                ...
                <x-input-with-label-element id="title" label="Satsang title" name="title"
                    required></x-input-with-label-element>
                <x-text-area-with-label id="short_desc" label="Satsang Short Description" name="short_desc"
                    required></x-text-area-with-label>
                <x-text-area-with-label id="content" label="Satsang Description" name="description"
                    required></x-text-area-with-label>
        ...
        <x-card-element header="Satsang Data">
            <x-data-table>
